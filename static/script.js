...
//         itemSelectText: '',
//         placeholder: true,
//         placeholderValue: 'Select Operation',
//     });
...
//     calculateFields();
//     updateCoatingFields();
//     updateOperationBox(); // Update the operation box on change
// });
...
// // New functionality: Display operation in a box with remove button
// function updateOperationBox() {
//     const operation = document.querySelector('#operation').value;
//     const container = document.querySelector('#operation-box-container');
//     container.innerHTML = ''; // Clear existing box
...
//             const choicesInstance = Choices.getInstance(operationSelect);
//             choicesInstance.setChoiceByValue(''); // Reset to placeholder
//             container.innerHTML = ''; // Remove the box
//             resetOperationFields(); // Clear operation-related fields
//             calculateFields(); // Recalculate totals
//         });

//         box.appendChild(operationText);
//         box.appendChild(removeBtn);
//         container.appendChild(box);
//     }
// }

// // Reset operation-specific fields when operation is removed
// function resetOperationFields() {
//     const operationFields = {
//         'Milling': ['fm', 'fm_side_cost', 'fm_l'],
//         'Drilling': [
//             'hole_4_8', 'hole_9_13', 'hole_15_22', 'free_hole_cost', 
//             'hole_m4', 'hole_m5', 'hole_m6', 'hole_m8', 'hole_m10', 'hole_m12', 'hole_m14', 
//             'hole_m16', 'hole_m18', 'hole_m20', 'hole_m22', 'hole_m24', 'hole_m25', 'hole_m26', 
...
//             'bsp_tap_1_2_3_8', 'bsp_tap_1_inch', 'bsp_tap_1_5_2_inch', 'bsp_tap_cost', 
//             'gd_total_hole_length', 'gd_cost_gd_machine', 'gd_total_hole_length_dro_radial_drilling', 
//             'gd_cost_dro_radial_drilling', 'spot_face', '4_5_h7', '6_8_h7', '10_14_h7', 
//             '15_18_h7', '20_25_h7', '25_30_h7', 'h7_hole_cost'
//         ],
//         'Grinding': ['sg', 'sgl'],
//         'Heat Treatment': ['ht'],
//         'Coating': ['blackening', 'enp', 'flash_chrome', 'pc', 'zinc_blue'],
//         'VMC': ['vmc'],
//         'Wire Cut': ['wire_cut_sp', 'wire_cut_dp', 'wire_cut_tp'],
//         'CG': ['cg'],
//         'Turning': ['turning'],
...
//     // Reset all operation-related fields to empty
//     Object.values(operationFields).flat().forEach(field => {
//         const input = document.querySelector(`input[name="${field}"]`);
//         if (input) input.value = '';
//     });

//     // Reset dependent dropdowns
//     const htRequiredChoices = Choices.getInstance(document.querySelector('#ht_required'));
//     const coatingTypeChoices = Choices.getInstance(document.querySelector('#coating_type'));
//     htRequiredChoices.setChoiceByValue('');
//     coatingTypeChoices.setChoiceByValue('');

//     // Hide all operation-related fields
//     const allFields = Object.values(operationFields).flat();
//     allFields.forEach(name => {
//         const field = document.querySelector(`label:has(input[name="${name}"])`);
//         if (field) field.classList.add('hidden');
//     });
//     ['ht_required', 'coating_type'].forEach(name => {
//         const field = document.querySelector(`label:has(#${name})`);
//         if (field) field.classList.add('hidden');
//     });
// }
